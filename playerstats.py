...
class item:
    def __init__(self, slot, name, description, action, tier, quantity, value, affect, val1, val2, val3, effects):
        self.slot = slot
        self.name = name
...
hearty_stew = item("consumable", "Bowl of Hearty Stew", "A warm bowl of stew that restores 75 Energy and grants the 'Well Fed' buff for the next 5 encounters", food_action, 3, 0, 40, "Energy", 75, 0, 0, [["Well Fed", 5, "user"]])
poisoned_throwing_knife = item("consumable", "Poison Throwing Knife", "A throwing knife that deals 25 Damage and inflicts a deadly poison", damage_action, 4, 0, 20, "Damage", 25, 0, 0, [["Poison", 3, "target"]])
