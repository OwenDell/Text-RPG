...
small_health_potion = item("Consumables", "Small Health Potion", f"A small red flask that heals you for 20 HP when drank", health_potion_action, 1, 5, 10, "Health", 20, 0, 0, [], -1)
health_potion = item("Consumables", "Health Potion", f"A red bottle that heals you for 50 HP when drank", health_potion_action, 3, 0, 40, "Health", 50, 0, 0, [], -1)
large_health_potion = item("Consumables", "Large Health Potion", f"A large red draught that heals you for 100 HP when drank", health_potion_action, 7, 0, 125, "Health", 100, 0, 0, [], -1)
small_mana_potion = item("Consumables", "Small Mana Potion", f"A small blue flask that restores 10 MP when drank", mana_potion_action, 1, 3, 7, "Mana", 10, 0, 0, [], -1)
mana_potion = item("Consumables", "Mana Potion", f"A blue bottle that restores 30 MP when drank", mana_potion_action, 3, 0, 30, "Mana", 35, 0, 0, [], -1)
large_mana_potion = item("Consumables", "Large Mana Potion", f"A large blue draught that restores 75 MP when drank", mana_potion_action, 6, 0, 100, "Mana", 75, 0, 0, [], -1)
...
eternal_poison_vial = item("Consumables", "Eternal Poison Vial", "Afflicts the drinker with a permanent minor poison", "Potion", -5, 0, 100, "Potion", 0, 0, 0, [["Lesser Poison", -1, "user"]], -1)
holy_water = item("Consumables", "Holy Water", "Cures you of nearly every ailment and restores 100 HP", "Potion", 10, 0, 300, "Health", 100, 0, 0, [["Cleanse", 0, "user"]], -1)
