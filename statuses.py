...
class Status:
    ...
    def apply(self, target, duration):
        ...
        if duration == -1:
            print(f"{message} received the status effect {self.name} indefinitely.")
    ...
    def cure(self, target, index):
        message = "You've" if target is player else f"The {target.name} has"
        print(f"{message} been cured of {self.name}!")
...
strength_down1 = Standard_Effect("-1 Strength", 5, "has returned to normal", 1, "Strength", "-")
dexterity_up1 = Standard_Effect("+1 Dexterity", 3, "increased", 1, "Dexterity", "+")
dexterity_down1 = Standard_Effect("-1 Dexterity", 5, "has returned to normal", 1, "Dexterity", "-")
Intelligence_up1 = Standard_Effect("+1 Intelligence", 3, "increased", 1, "Intelligence", "+")
Intelligence_down1 = Standard_Effect("-1 Intelligence", 5, "has returned to normal", 1, "Intelligence", "-")
